...
aBuscoListLineages cfg ref _ listTmp = do
  ...
  where
    ...
    allLineages =
      [ "datasets/bacteria_odb9"
      , "datasets/proteobacteria_odb9"
      , "datasets/rhizobiales_odb9"
      , "datasets/betaproteobacteria_odb9"
      , "datasets/gammaproteobacteria_odb9"
      , "datasets/enterobacteriales_odb9"
      , "datasets/deltaepsilonsub_odb9"
      , "datasets/actinobacteria_odb9"
      , "datasets/cyanobacteria_odb9"
      , "datasets/firmicutes_odb9"
      , "datasets/clostridia_odb9"
      , "datasets/lactobacillales_odb9"
      , "datasets/bacillales_odb9"
      , "datasets/bacteroidetes_odb9"
      , "datasets/spirochaetes_odb9"
      , "datasets/tenericutes_odb9"
      , "datasets/eukaryota_odb9"
      , "datasets/fungi_odb9"
      , "datasets/microsporidia_odb9"
      , "datasets/dikarya_odb9"
      , "datasets/ascomycota_odb9"
      , "datasets/pezizomycotina_odb9"
      , "datasets/eurotiomycetes_odb9"
      , "datasets/sordariomyceta_odb9"
      , "datasets/saccharomyceta_odb9"
      , "datasets/saccharomycetales_odb9"
      , "datasets/basidiomycota_odb9"
      , "datasets/metazoa_odb9"
      , "datasets/nematoda_odb9"
      , "datasets/arthropoda_odb9"
      , "datasets/insecta_odb9"
      , "datasets/endopterygota_odb9"
      , "datasets/hymenoptera_odb9"
      , "datasets/diptera_odb9"
      , "datasets/vertebrata_odb9"
      , "datasets/actinopterygii_odb9"
      , "datasets/tetrapoda_odb9"
      , "datasets/aves_odb9"
      , "datasets/mammalia_odb9"
      , "datasets/euarchontoglires_odb9"
      , "datasets/laurasiatheria_odb9"
      , "datasets/embryophyta_odb9"
      , "datasets/protists_ensembl"
      , "datasets/alveolata_stramenophiles_ensembl"
      , "prerelease/chlorophyta_odb10"
      , "prerelease/embryophyta_odb10"
      , "prerelease/eudicotyledons_odb10"
      , "prerelease/liliopsida_odb10"
      , "prerelease/solanaceae_odb10"
      , "prerelease/viridiplantae_odb10"
      ]
...
rBuscoFetchLineage st@(_, cfg, ref, _) expr@(CutFun _ _ _ _ [nPath]) = do
  ...
  outPath' %> \_ -> do
    ...
    let untarPath = bulDir </> nameStr
        url       = "http://busco.ezlab.org/v2/" ++ nameStr ++ ".tar.gz"
