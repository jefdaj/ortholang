...
import ShortCut.Core.Actions (traceA, writeLits, runCmd, CmdDesc(..), readLit, readPaths, writePaths,
...
import ShortCut.Core.Util         (resolveSymlinks, unlessExists, headOrDie)
...
buscoFilterCompleteness :: CutFunction
buscoFilterCompleteness  = CutFunction
  { fName      = name
