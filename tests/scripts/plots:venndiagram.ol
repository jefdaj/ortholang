...
d_one   = venndiagram "a diagram" [l1]
d_two   = venndiagram "a diagram" [l1, l2]
d_three = venndiagram "a diagram" [l1, l2, l3]
d_four  = venndiagram "a diagram" [l1, l2, l3, l4]
d_five  = venndiagram "a diagram" [l1, l2, l3, l4, l5]
d_six   = venndiagram "a diagram" [l1, l2, l3, l4, l5, l6] # this should switch to UpSetR

# this caught a bug in the label ordering once
d_five_unordered = venndiagram "a diagram" [l2,l5,l1,l3,l4]
