...
sdbfna = [blastn_db 1.0e-5 qfna (makeblastdb_fna sfna1), blastn_db 1.0e-5 qfna (makeblastdb_fna sfna2)]
sdbfaa = [blastp_db 1.0e-5 qfaa (makeblastdb_faa sfaa1), blastp_db 1.0e-5 qfaa (makeblastdb_faa sfaa2)]
sfafaa = [blastp 1.0e-5 qfaa sfaa1, blastp 1.0e-5 qfaa sfaa2]
mdbfna = blastn_db_each 1.0e-5 qfna [makeblastdb_fna sfna1, makeblastdb_fna sfna2]
