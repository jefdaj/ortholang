{ mkDerivation, ansi-terminal, base, bytestring, Command
, concurrent-extra, configurator, containers, cryptohash
, data-default-class, directory, dlist, docopt, enclosed-exceptions
, exceptions, filelock, filepath, Glob, haskeline, hspec, MissingH
, mtl, parsec, path, path-io, posix-escape, pretty, process
, QuickCheck, random, random-shuffle, regex-compat, retry
...
mkDerivation {
  ...
  executableHaskellDepends = [
    ansi-terminal base bytestring Command concurrent-extra configurator
