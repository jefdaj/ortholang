...
-- TODO parametarize FilePath and re-export with DtrPath in Types.hs?
type Locks = IORef (Map FilePath RWLock)

{- A horrible hack to avoid import the import cycle caused by using a DtrConfig
