...
pVar :: ParseM RrrVar
pVar = debugParser "pVar" (RrrVar <$> pIden)
...
pStr :: ParseM RrrExpr
pStr = debugParser "pStr" (RrrLit str 0 <$> pQuoted <?> "string literal")
